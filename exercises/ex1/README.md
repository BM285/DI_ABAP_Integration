...
In the next exercise we will conduct all necessary steps to create a custom ABAP operator in SAP S/4HANA and trigger its execution from a Pipeline in SAP Data Intelligence.
Please continue to [Exercise 2 - Calling an ABAP function module in SAP S/4HANA from SAP Data Intelligence](../ex2/README.md).
